...
$target1 = '\\corporatenetwork\DailyData\FTPIN\dailyreport20141114.xlsx'
...
Copy-Item '\\corporatenetwork\DailyData\FTPIN\dailyreport*.xlsx' '\\corporatenetwork\DailyData\FTPOUT\dailyreport.xlsx'
